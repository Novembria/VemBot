...
exports.serialize = (ramlan, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.fromMe = msg.quotedMsg.sender === ramlan.user.jid ? true : false
    ...
    const conts = msg.key.fromMe ? ramlan.user.jid : ramlan.contacts[msg.sender]
	msg.pushname = msg.key.fromMe ? ramlan.user.name : !conts ? '-' : conts.notify || conts.vname || conts.name || '-'   
