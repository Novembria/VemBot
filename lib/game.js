...
const cekWaktuFam = (geps, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            geps.sendMessage(_dir[position].id, juwu, MessageType.text)
            _dir.splice(position, 1)
        }
    }, 1000)
}
